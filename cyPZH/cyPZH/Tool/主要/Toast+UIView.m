...
//static const CGSize  CSToastShadowOffset        = { 50.0, 50.0 };
...
- (void)showToast:(UIView *)toast duration:(CGFloat)interval position:(id)point {
    ...
    toast.center =CGPointMake([APPDELEGATE window].frame.size.width/2, [APPDELEGATE window].frame.size.height/2);
    toast.alpha = 0.0;
...
//       CGSize expectedSizeTitle = [title sizeWithFont:titleLabel.font constrainedToSize:maxSizeTitle lineBreakMode:titleLabel.lineBreakMode];
        ...
        CGSize expectedSizeTitle = [titleLabel.text boundingRectWithSize:maxSizeTitle options: NSStringDrawingUsesLineFragmentOrigin  attributes:attribute context:nil].size;
